...
contents += load_contents('Apricitas', 'https://www.apricitas.io/feed')
...
contents += load_contents('HighModernism','https://www.highmodernism.com/blog?format=rss')
...
contents += load_contents('INFERPub', 'https://us1.campaign-archive.com/feed/?u=4a86f59493f5485c66dfb5beb&id=07c26b6cae')
...
contents += load_contents('Keller', 'https://keller.substack.com/feed')
...
contents += load_contents('Tilt', 'https://www.nytimes.com/svc/collections/v1/publish/https://www.nytimes.com/column/the-tilt/rss.xml')
