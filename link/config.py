...
AGGREGATOR_WEIGHTS = Case(When(Q(aggregator__exact='Dispatch') &
                          ...
                          When(Q(aggregator__exact='FPChina'), then=10),
                          When(Q(aggregator__exact='FPSouthAsia'), then=10),
                          When(Q(aggregator__exact='FP-WYWL'), then=10),
                          When(Q(aggregator__exact='ChinAI'), then=10),
                          When(Q(aggregator__exact='ImportAI'), then=10),
                          When(Q(aggregator__exact='Alignment'), then=10),
